...
{
    if ([self.delegate respondsToSelector:@selector(treeView:trailingSwipeActionsConfigurationForItem:)])
    {
        RATreeNode *treeNode = [self treeNodeForIndexPath:indexPath];
        return [self.delegate treeView:self trailingSwipeActionsConfigurationForItem:treeNode.item];
    }
