...
//  ККВФ
//
//  Created by Акифьев Максим  on 21.05.2021.
//
...
struct KeychainPasswordItem {
    ...
    func readData() throws -> NSDictionary  {
        /*
        ...
        */
        ...
        guard let existingItem = queryResult as? [String : AnyObject],
            ...
            let password = NSKeyedUnarchiver.unarchiveObject(with: passwordData) as? NSDictionary
        else {
    ...
    func saveData(_ dict: NSDictionary) throws {
        // Encode the password into an Data object.
        let encodedPassword = NSKeyedArchiver.archivedData(withRootObject: dict)
...
struct Constants {
    static let server = "KKVF"
}
protocol WritableKeychain {
    func prepareKey(_ key: String) throws
    func saveUserCredentials(credentials: Credentials) throws
}
protocol ReadableKeychain {
    var key: String { get }
    var credentials: Credentials { get }
}

extension WritableKeychain {
    ...
    func saveUserCredentials(credentials: Credentials) throws {
        ...
        guard let password = credentials.password.data(using: .utf8) else {
            fatalError("Password value can't be convert to expected object")
        }
        let data = ["username" : userName,
                    "password" : password,
                    "pincode": pinCode] as [String : Any]
        
        let attributes: [Data: Any] = [kSecValueData as! Data: NSKeyedArchiver.archivedData(withRootObject: data)
        ]
